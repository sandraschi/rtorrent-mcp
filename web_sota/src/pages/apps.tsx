    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-2xl font-bold tracking-tight text-white">Local shortcuts</h2>
                    <p className="text-slate-400">
                        Manual links — <strong className="text-amber-200/90">no</strong> fleet auto-discovery.
                    </p>
                </div>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                {SHORTCUTS.map((app) => (
                    <Card
                        ...
                        onClick={() => window.open(`http://127.0.0.1:${app.port}`, "_blank")}
                    >
            ...
            <Card className="border-slate-800 bg-slate-950/50 border-dashed">
                <CardContent className="py-8 text-center text-sm text-slate-500">
                    ...
                    <code className="text-xs text-slate-400">apps.tsx</code> — nothing polls the network.
                </CardContent>
            </Card>
        </div>
    );
