...
```
┌─────────────────┐    ┌─────────────────┐    ┌─────────────────┐
│   Claude Desktop │───│   FastMCP 2.12  │───│    rTorrent     │
│                 │    │  MCP Server     │    │   SCGI API      │
└─────────────────┘    └─────────────────┘    └─────────────────┘
                              │
                              ▼
...
#### Legal Warnings
```
⚠️ Content may violate Austrian copyright law
🇦🇹 Personal use exemption applies to small downloads
