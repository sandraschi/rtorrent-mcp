...
Environment Variables:
    ...
    MCP_PORT: Port for HTTP/SSE. Default: 10910 (fleet 10700+; set MCP_PORT to override)
...
ENV_PORT = "MCP_PORT"  # default: 10910
...
Environment Variables:
  ...
  {ENV_PORT}         Port number (default: 10910)
...
Examples:
  ...
  # HTTP mode (web apps)
  python -m {server_name.replace("-", "_")} --http --port 10910

  # Via environment
  MCP_TRANSPORT=http MCP_PORT=10910 python -m {server_name.replace("-", "_")}
""",
    )
